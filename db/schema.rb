...
ActiveRecord::Schema.define(version: 2020_09_07_113938) do
  ...
  create_table "gangs", force: :cascade do |t|
    ...
    t.string "house", default: "Other"
    t.index ["user_id"], name: "index_gangs_on_user_id"
  end
